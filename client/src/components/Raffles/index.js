...
function CardContainer() {
    ...
    {title: "Shrek Beard", description: "Shrek Beard with matching fedora", image: img2 }, 
    ...
    {title: "Quarter", description: "Shiny new quarter", image: img5}]; // --> Think of this as STATE
